import{r as t,q as U,e as I,f as R,j as e,L as o,a as w,t as A}from"./index-Csm0NulF.js";const F=t.createContext(),P=()=>{const r=t.useContext(F);if(!r)throw new Error("useGlobalTranslation must be used within TranslationProvider");return r},q="/assets/logo-removebg-preview-CazftZ_M.webp";function H(){const[r,b]=t.useState(!1),[j,v]=t.useState([]),[N,x]=t.useState(!0),[p,y]=t.useState(""),[C,u]=t.useState(!1),c=U(a=>a.isLoggedIn)(),f=I(),k=R(),{t:s,changeLanguage:M,getCurrentLanguage:L}=P(),[i,z]=t.useState(L()),g=a=>{M(a),z(a)};t.useEffect(()=>{let a;return r&&(a=setTimeout(()=>{b(!1),f("/")},1500)),()=>clearTimeout(a)},[r]),t.useEffect(()=>{(async()=>{try{x(!0);const l=await w.get("post/category/list/");v(l.data)}catch(l){console.error("Failed to fetch categories:",l)}finally{x(!1)}})()},[]);const S=()=>{A(!1),b(!0)},h=async()=>{if(!c){u(!1);return}try{const l=(await w.get("contact-message/list/")).data.some(m=>!m.responded);u(l)}catch(a){console.error("Failed to fetch contact messages:",a)}};return t.useEffect(()=>{h();const a=()=>{if(!c){u(!1);return}h()};return window.addEventListener("contactMessagesUpdated",a),()=>{window.removeEventListener("contactMessagesUpdated",a)}},[c]),t.useEffect(()=>{h()},[k]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
