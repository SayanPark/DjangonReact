import{r as n,q as M,e as z,f as L,j as e,L as t,a as b,t as S}from"./index-BRrys8nQ.js";const E="/logo-removebg-preview.webp";function U(){const[d,g]=n.useState(!1),[x,f]=n.useState([]),[j,u]=n.useState(!0),[c,w]=n.useState(""),[v,m]=n.useState(!1),i=M(a=>a.isLoggedIn)(),h=z(),N=L();n.useEffect(()=>{let a;return d&&(a=setTimeout(()=>{g(!1),h("/")},1500)),()=>clearTimeout(a)},[d]),n.useEffect(()=>{(async()=>{try{u(!0);const o=await b.get("post/category/list/");f(o.data)}catch(o){console.error("Failed to fetch categories:",o)}finally{u(!1)}})()},[]);const y=()=>{S(!1),g(!0)},p=async()=>{if(!i){m(!1);return}try{const o=(await b.get("contact-message/list/")).data.some(l=>!l.responded);m(o)}catch(a){console.error("Failed to fetch contact messages:",a)}};return n.useEffect(()=>{p();const a=()=>{if(!i){m(!1);return}p()};return window.addEventListener("contactMessagesUpdated",a),()=>{window.removeEventListener("contactMessagesUpdated",a)}},[i]),n.useEffect(()=>{p()},[N]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
